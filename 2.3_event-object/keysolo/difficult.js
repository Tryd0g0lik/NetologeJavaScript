// файл 'difficult' из 'keysolo' задачи.
// День добрый
// Хотелось бы выполнить и сложные задачи.
// Вставил таймер. 

// Но не могу продумать условие для регистра.
// кАКое условие для работы с заглавными символами?  Как их сравнивать с клавиатурой?

// а так же
// `if (++this.winsElement.textContent === 10)` какую роль играют "++"?
// 		Пытался использовать аналогично, но не заработало. Пришлось тип "Number" данных прописывать 

// и вопрос не по теме. 
// Если Вы работаете с Pycharm-prof, то через какой ресурс проводите оплату за лицензию? 
